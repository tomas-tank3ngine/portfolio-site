    ...
    <>
        ...
        <section className="modal">
            ...
            <section className="modal__buttons">
                <Link to={item.site_link} target="_blank" className="modal__buttons--site">Visit Website</Link>
                <Link to={item.repo_link} target="_blank" className="modal__buttons--repo">Github Repo</Link>
            </section>
        </section>
            <div onClick={handleModal} className="background">
            </div>
    </>
  );
}
